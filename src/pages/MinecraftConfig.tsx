...
const MinecraftConfig = () => {
  ...
  const serverTypes = [
    { id: 'vanilla', name: 'Vanilla Minecraft', description: 'Official Minecraft server without modifications', price: 'Free' },
    { id: 'paper', name: 'Paper', description: 'High-performance server with optimizations', price: 'Free' },
    { id: 'spigot', name: 'Spigot', description: 'Plugin-compatible server platform', price: 'Free' },
    { id: 'forge', name: 'Forge', description: 'Mod support with Minecraft Forge', price: 'Free' },
    { id: 'fabric', name: 'Fabric', description: 'Lightweight mod support with Fabric', price: 'Free' }
  ];

  const modpacks = [
    { id: 'vanilla', name: 'Vanilla', description: 'Pure Minecraft experience', price: 'Free' },
    { id: 'rlcraft', name: 'RLCraft', description: 'Hardcore survival modpack with dragons', price: 'Free' },
    { id: 'atm9', name: 'All The Mods 9', description: 'Kitchen sink modpack with 400+ mods', price: 'Free' },
    { id: 'create', name: 'Create Above & Beyond', description: 'Engineering and automation focused', price: 'Free' },
    { id: 'skyfactory', name: 'Sky Factory 4', description: 'Skyblock with tech progression', price: 'Free' }
  ];
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-6">
                ...
                <div className="mt-4">
                  <div className="bg-emerald-500 text-white px-4 py-2 rounded-lg inline-block">
                    {selectedPlan?.ram} + Vanilla Minecraft = Optimal Performance
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-4 gap-4">
                  ...
                  <div className="border border-gray-600 rounded-lg p-4 cursor-pointer hover:border-gray-500 transition-colors">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-emerald-400 font-bold">$5.99/mo</span>
                    </div>
                    <ul className="text-sm text-gray-400 space-y-1">
                      <li>• Priority support queue</li>
              ...
              <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-6">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 mb-2"
                >
