...
const RustConfig = () => {
  ...
  const serverTypes = [
    { id: 'vanilla', name: 'Vanilla Rust', description: 'Official Rust server without modifications', price: 'Free' },
    { id: 'oxide', name: 'Oxide', description: 'Plugin support with Oxide framework', price: 'Free' },
    { id: 'umod', name: 'uMod', description: 'Advanced plugin and mod support', price: 'Free' },
    { id: 'custom', name: 'Custom', description: 'Custom server configuration', price: 'Free' }
  ];

  const modpacks = [
    { id: 'vanilla', name: 'Vanilla', description: 'Pure Rust experience', price: 'Free' },
    { id: 'battlefield', name: 'Battlefield', description: 'Large-scale warfare modpack', price: 'Free' },
    { id: 'pve', name: 'PvE Focused', description: 'Player vs Environment focused', price: 'Free' },
    { id: 'roleplay', name: 'Roleplay', description: 'Roleplay and RP modpack', price: 'Free' },
    { id: 'zombie', name: 'Zombie Survival', description: 'Zombie apocalypse modpack', price: 'Free' }
  ];
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-6">
                ...
                <div className="mt-4">
                  <div className="bg-orange-500 text-white px-4 py-2 rounded-lg inline-block">
                    {selectedPlan?.ram} + Vanilla Rust = Optimal Performance
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-4 gap-4">
                  ...
                  <div className="border border-gray-600 rounded-lg p-4 cursor-pointer hover:border-gray-500 transition-colors">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-orange-400 font-bold">$5.99/mo</span>
                    </div>
                    <ul className="text-sm text-gray-400 space-y-1">
                      <li>• Priority support queue</li>
              ...
              <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-6">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-orange-500 mb-2"
                >
              ...
              <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-6">
                ...
                <div className="flex space-x-4 mb-4">
                  ...
                  <button
                    onClick={() => setModpack('battlefield')}
                    className={`px-4 py-2 rounded-lg transition-colors ${
                      modpack === 'battlefield' 
                        ? 'bg-orange-500 text-white' 
                        : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
