...
const RimworldConfig = () => {
  ...
  const [planId, setPlanId] = useState('rimworld-2gb');
  ...
  const plans = [
    { id: 'rimworld-1gb', name: 'Rimworld 1GB', price: '$3.99', ram: '1GB', players: '2-4' },
    { id: 'rimworld-2gb', name: 'Rimworld 2GB', price: '$5.99', ram: '2GB', players: '4-8' },
    { id: 'rimworld-4gb', name: 'Rimworld 4GB', price: '$9.99', ram: '4GB', players: '8-16' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold mb-6">
            <span className="bg-gradient-to-r from-red-400 via-pink-400 to-red-400 bg-clip-text text-transparent">
              Configure Your Rimworld Server
            </span>
          </h1>
          
          <p className="text-xl text-gray-300 max-w-3xl mb-12">
            Set up your Rimworld server for colony simulation and management.
          </p>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {plans.map((plan) => (
                    ...
                    >
                      ...
                      <div className="text-red-400 font-bold">{plan.price}/month</div>
