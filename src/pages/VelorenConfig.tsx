...
const VelorenConfig = () => {
  ...
  const [planId, setPlanId] = useState('veloren-2gb');
  ...
  const plans = [
    { id: 'veloren-2gb', name: 'Veloren 2GB', price: '$4.99', ram: '2GB', players: '4-8' },
    { id: 'veloren-4gb', name: 'Veloren 4GB', price: '$7.99', ram: '4GB', players: '8-16' },
    { id: 'veloren-8gb', name: 'Veloren 8GB', price: '$12.99', ram: '8GB', players: '16-32' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold mb-6">
            <span className="bg-gradient-to-r from-indigo-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent">
              Configure Your Veloren Server
            </span>
          </h1>
          
          <p className="text-xl text-gray-300 max-w-3xl mb-12">
            Set up your Veloren server for open world voxel RPG adventures.
          </p>
          ...
          <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-8">
            ...
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {plans.map((plan) => (
                    ...
                    >
                      ...
                      <div className="text-indigo-400 font-bold">{plan.price}/month</div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:transform-none disabled:cursor-not-allowed"
              >
                {loading ? 'Creating Server...' : 'Deploy Veloren Server'}
              </button>
            </div>
          </div>
        </div>
