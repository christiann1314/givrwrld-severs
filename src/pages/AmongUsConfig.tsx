...
const AmongUsConfig = () => {
  ...
  const [planId, setPlanId] = useState('among-us-1gb');
  ...
  const plans = [
    { id: 'among-us-1gb', name: 'Among Us 1GB', price: '$1.99', ram: '1GB', players: '4-10' },
    { id: 'among-us-2gb', name: 'Among Us 2GB', price: '$2.99', ram: '2GB', players: '10-15' },
    { id: 'among-us-4gb', name: 'Among Us 4GB', price: '$4.99', ram: '4GB', players: '15+ players' }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold mb-6">
            <span className="bg-gradient-to-r from-pink-400 via-rose-400 to-pink-400 bg-clip-text text-transparent">
              Configure Your Among Us Server
            </span>
          </h1>
          
          <p className="text-xl text-gray-300 max-w-3xl mb-12">
            Set up your Among Us server for social deduction multiplayer fun.
          </p>
          ...
          <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-8">
            ...
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {plans.map((plan) => (
                    ...
                    >
                      ...
                      <div className="text-pink-400 font-bold">{plan.price}/month</div>
                      <div className="text-sm text-gray-400">{plan.ram} RAM • {plan.players}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              >
                {loading ? 'Creating Server...' : 'Deploy Among Us Server'}
              </button>
            </div>
          </div>
        </div>
