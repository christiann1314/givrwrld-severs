...
const PalworldConfig = () => {
  ...
  const serverTypes = [
    { id: 'vanilla', name: 'Vanilla Palworld', description: 'Official Palworld server without modifications', price: 'Free' },
  ...
  const modpacks = [
    { id: 'vanilla', name: 'Vanilla', description: 'Pure Palworld experience', price: 'Free' },
    { id: 'enhanced', name: 'Enhanced', description: 'Enhanced gameplay with quality of life improvements', price: 'Free' },
    { id: 'hardcore', name: 'Hardcore', description: 'Hardcore survival experience', price: 'Free' },
    { id: 'creative', name: 'Creative', description: 'Creative building focused', price: 'Free' }
  ];
              ...
              <div className="bg-gray-800/60 backdrop-blur-md border border-gray-600/50 rounded-xl p-6">
                ...
                <div className="mt-4">
                  <div className="bg-emerald-500 text-white px-4 py-2 rounded-lg inline-block">
                    {selectedPlan?.ram} + Vanilla Palworld = Optimal Performance
                  </div>
                </div>
              </div>
