-- Complete Stripe Price ID Update Script
-- Run this in Supabase SQL Editor to update all plans with live Stripe prices
...
-- Palworld Plans (NEW - Just created)
...
SELECT 
  ...
  display_name,
  CASE 
    WHEN stripe_price_id LIKE 'price_1SQK%' THEN '✅ Live (Palworld)'
    WHEN stripe_price_id LIKE 'price_1SP%' THEN '✅ Live'
